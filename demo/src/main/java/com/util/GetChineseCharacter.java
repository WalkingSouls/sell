...
public class GetChineseCharacter {
     ...
     * @return
     */
    private static String getCommonChineseCharacter(int num){
        ...
        for (int i = 0; i < num; i++) {
            String nameTemp = base.charAt(new Random().nextInt(base.length())) + "";
            sb = sb.append(nameTemp);
        }
        return sb.toString();
    }
    /**
     ...
     * @return
     */
    private static String getChineseCharacter(int num){
        StringBuffer sb = new StringBuffer();
        for (int i = 0; i < num; i++) {
